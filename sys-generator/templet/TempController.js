/**
 * 
 * <p> Title:${className} EXTJS CONTROLLER</p>
 ...
 * @version 1.0
 */
Ext.define('${JS_PATH_controller}.${className}Controller', {
	extend : 'app.ctrl.BaseCtrl',
	alias:'controller.${lowerName}',
	init : function(view){
    ...
    onUpdateClick : function(){
	    ...
	    if(records[0]){
	    	var winCfg = {
	    			icon : records ? 'fa fa-pencil' : 'fa fa-plus',
	    			title : '编辑系统资源【'+records[0].data.mkmc+'】'
	    	};
	    	var cfg = Ext.apply({
	            xtype: 'baseWin',
	            items: [
