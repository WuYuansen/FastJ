 ...
 */
 Ext.define('app.store.sys.Role',{
    ...
    proxy: {
        ...
        api : {
        	read: constants.url.sys.role.findByPaging,
            create: constants.url.sys.role.save,
            update: constants.url.sys.role.update,
            destroy: constants.url.sys.role.deleteById
        },
        reader: {
            type: 'json',	//返回数据类型
