       ...
       <form class="my-form" name="form" data-auto="false" method="post">
        <ul class="flexbox je-box-left jew100 f14">
                <li class="flexbox je-box-left jew25">
                    <span class="flexbox je-text-right pl10 pr10">模块名称：</span>
                    <p class="flexbox jeflex"><input type="text" class="my-input" name="name" placeholder="请输入"></p>
                </li>
                <li class="flexbox je-box-left jew25">
                	<span class="flexbox je-text-left pl10 pr10">类型：</span>
                    <p class="flexbox jeflex">
                        <select name="extendclass">
                            <option value="">请选择</option>
                        <c:forEach var="k" items="${fns:getDicByType('menuType')}" >
...
<div name="right_code" style="display:none;">
<c:forEach var="k" items="${fns:getDicByType('ModularRight') }">
<i class="${k.remarks }" value="${k.keycode}"></i>
</c:forEach>
</div>