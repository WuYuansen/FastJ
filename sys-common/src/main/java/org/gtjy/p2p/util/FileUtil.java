...
/**
 * 
 * <p> Title: 文件操作工具类 实现文件的创建、删除、复制、压缩、解压以及目录的创建、删除、复制、压缩解压等功能</p>
 * <p> Description: </p>
...
public class FileUtil extends FileUtils {
	...
	public static void main(String[] args) {
        String filePath = "F:\\upload\\xybg\\20141225\\123\\20141225191542_735.png";
        File temp = new File(filePath);
        filePath = filePath.replace(temp.getName(), "");
